...
class Modalprovact extends React.Component {
    state = {
        abierto: false,
    }
                ...
                <Modal isOpen={this.state.abierto} style={modalStyles, { maxWidth: "40%",maxHeight:"100%",overflowY:"scroll"}}>
                    ...
                    <ModalBody>
                        ...
                        <FormGroup >
                            ...
                            <input style={{ left: "190px", position: "relative" }} type="text" id="usuario" />
                        </FormGroup>
                        <FormGroup >
                        ...
                        <Button style={{position: "relative",left:"40%", color: "black", backgroundColor: "#95FF0E" }} onClick={this.abrirModal}>AÑADIR</Button>
                    </ModalBody>
                    <ModalFooter>
